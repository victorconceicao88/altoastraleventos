...
const menu = {
 ...
 bebidas: [
  ...
  { id: 70, name: 'Água das Pedras', price: 1.50, image: foodImages.bebida, rating: 4.3 },
  { id: 71, name: 'Água das Pedras C/ Sabor', price: 1.80, image: foodImages.bebida, rating: 4.3 }
],
salgados: [
  { id: 72, name: 'Pão de Queijo', price: 1.60, image: foodImages.salgado, rating: 4.5 },
  { id: 73, name: 'Pastel de Nata', price: 1.30, image: foodImages.salgado, rating: 4.7 },
  { id: 74, name: 'Empada de Frango', price: 2.00, image: foodImages.salgado, rating: 4.4 },
  { id: 75, name: 'Kibe', price: 2.20, image: foodImages.salgado, rating: 4.3 },
  { id: 76, name: 'Fiambre e Queijo', price: 2.20, image: foodImages.salgado, rating: 4.2 },
  { id: 77, name: 'Bauru', price: 2.20, image: foodImages.salgado, rating: 4.1 },
  { id: 78, name: 'Bola de Queijo', price: 2.20, image: foodImages.salgado, rating: 4.3 },
  { id: 79, name: 'Coxinha de Frango', price: 2.20, image: foodImages.salgado, rating: 4.6 },
  { id: 80, name: 'Coxinha com Catupiry', price: 3.00, image: foodImages.salgado, rating: 4.8 },
  { id: 81, name: 'Hamburgão', price: 3.50, image: foodImages.salgado, rating: 4.7 }
],
sobremesas: [
  { id: 82, name: 'Bolo no Pote - Prestígio', description: 'Chocolate com coco', price: 4.00, image: foodImages.sobremesa, rating: 4.8 },
  { id: 83, name: 'Bolo no Pote - Chocolate', description: 'Massa de chocolate com recheio de chocolate', price: 4.00, image: foodImages.sobremesa, rating: 4.9 },
  { id: 84, name: 'Bolo no Pote - Ananás', description: 'Creme de ninho com pedaços de ananás', price: 4.00, image: foodImages.sobremesa, rating: 4.7 },
  { id: 85, name: 'Bolo no Pote - Choco Misto', description: 'Chocolate preto com ninho', price: 4.00, image: foodImages.sobremesa, rating: 4.8 },
  { id: 86, name: 'Cheesecake - Goiabada', price: 3.50, image: foodImages.sobremesa, rating: 4.7 },
  { id: 87, name: 'Cheesecake - Frutos Vermelhos', price: 3.50, image: foodImages.sobremesa, rating: 4.8 },
  { id: 88, name: 'Brigadeiro Tradicional', price: 1.50, image: foodImages.sobremesa, rating: 4.6 },
  { id: 89, name: 'Brigadeiro Beijinho', price: 1.50, image: foodImages.sobremesa, rating: 4.5 },
  { id: 90, name: 'Brigadeiro Ninho', price: 2.00, image: foodImages.sobremesa, rating: 4.8 },
  { id: 91, name: 'Brigadeiro Paçoca', price: 2.00, image: foodImages.sobremesa, rating: 4.7 },
  { id: 92, name: 'Brigadeiro Morango', price: 2.00, image: foodImages.sobremesa, rating: 4.8 },
  { id: 93, name: 'Brigadeiro Churros', price: 2.00, image: foodImages.sobremesa, rating: 4.9 },
  { id: 94, name: 'Tarte de Toblerone', price: 2.20, image: foodImages.sobremesa, rating: 4.7 },
  { id: 95, name: 'Bolo de Brigadeiro (fatia)', price: 2.20, image: foodImages.sobremesa, rating: 4.8 }
]
};